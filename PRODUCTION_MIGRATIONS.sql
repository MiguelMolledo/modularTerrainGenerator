...
-- =============================================
-- MIGRATION 14: Create test user — LOCAL DEV ONLY
-- File: 20260223000000_create_test_user.sql
-- =============================================
-- INTENTIONALLY OMITTED FROM PRODUCTION.
-- The test user (test@local.dev with a known fixed UUID and password) exists
-- only in supabase/migrations for local development. Never create it in a
-- production database — a known-credential account is an account-takeover risk.
-- If it was ever applied to the hosted project, delete it via
